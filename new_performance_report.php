...
<body>
    ...
    <h2>Enter a new performance report</h2>
    ...
    <?php
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST'):
            ...
            echo "<p>New performance report for: ".$name["FullName"]."</p><br>";


            $row = mysqli_fetch_assoc($result);
    ?>

    <form name="enter_new_salary" method="POST" action="submit_new_performance.php">
        ...
        <p>Enter a performance score</p>
        <table>

            <tr><td>
                <select name="new_score">
                <option value="ERROR" selected>Score...</option>
    ...
    <form name="select_employee" method="POST" action="new_performance_report.php">
        <table>
